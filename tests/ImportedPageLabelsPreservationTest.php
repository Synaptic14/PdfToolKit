...
final class ImportedPageLabelsPreservationTest extends TestCase
{
    public function testImportedPageLabelsArePreservedOnSave(): void
    {
        $pdf = $this->buildPdf([
        ...
        $this->assertStringContainsString('/Nums [0 << /S /r /P (intro-) /St 1 >>]', $bytes);
    }

    public function testInlinePageLabelsArePreservedOnSave(): void
    {
        $pdf = $this->buildPdf([
            1 => '<< /Type /Catalog /Pages 2 0 R /PageLabels << /Nums [0 << /S /D >>] >> >>',
            2 => '<< /Type /Pages /Kids [3 0 R] /Count 1 /MediaBox [0 0 200 400] >>',
            3 => '<< /Type /Page /Parent 2 0 R /Contents 4 0 R >>',
            4 => "<< /Length 0 >>\nstream\n\nendstream",
        ]);
        ...
        $this->assertStringContainsString('/PageLabels', $bytes);
        $this->assertStringContainsString('/Nums [0 << /S /D >>]', $bytes);
    }
